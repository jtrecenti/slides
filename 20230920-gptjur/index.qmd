---
title: "Aplicações do GPT-4 na Jurimetria"
...
Jurimetria é a aplicação da **estatística no direito**. Seu objetivo é descobrir **regras jurídicas** que não estão nas leis a partir das **marcas que o Direito deixa no mundo real**.
...
## Antonio Galves {background-image="img/galves.png" background-position-y="bottom 100px;" background-size="200px 200px cover" background-opacity=0.4}
...
![](img/chatgpt-1.png){width=75% fig-align="center"}
:::

:::{.fragment .fade-in}
![](img/chatgpt-2.png){width=75% fig-align="center"}
:::
...
<iframe src="https://irudnyts.github.io/openai/" width='100%' height='400'></iframe>
...
![](img/langchain.png){width=75% fig-align="center"}
