...
```{r taxonomia, out.width='100%', fig.cap="Reclassificações dos assuntos. Na parte da esquerda, a taxonomia atual. Na direita, a taxonomia proposta após análise dos casos."}
"img/taxonomia.png" %>% 
  magick::image_read() %>% 
  crop(top = 100, bottom = 10)
```
