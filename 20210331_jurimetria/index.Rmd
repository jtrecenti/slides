...
```{r ml, out.width='85%', fig.cap="Proporção acumulada do total de processos consumeristas pela quantidade de litigantes, ordenando-se pelos maiores litigantes em sete unidades federativas."}
"img/cnjml.png" %>% 
  magick::image_read() %>% 
...
```{r observatorio, out.width='70%', fig.cap="Relação entre remuneração do Administrador Judicial (AJ) e valor total da dívida da recuperanda. O valor máximo de remuneração do AJ deve ser de 5% do valor total da dívida."}
"img/obsfase2.png" %>% 
  magick::image_read() %>% 
...
- __Dados internos__ estão disponíveis nas bases da empresa ou escritório de advocacia.

]

.pull.right[

- __Dados externos__ são os dados do judiciário, obtidos na forma que definimos anteriormente. 
...
- Importante não é saber __o que é__, e sim __saber fazer__.
